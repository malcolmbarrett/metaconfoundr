# Getting help with metaconfoundr

Thanks for using metaconfoundr. Before filing an issue, there are a few places
...
Before opening a new issue, be sure to [search issues and pull requests](https://github.com/malcolmbarrett/metaconfoundr/issues) to make sure the 
