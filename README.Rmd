...
[![Codecov test coverage](https://codecov.io/gh/malcolmbarrett/metaconfoundr/branch/master/graph/badge.svg)](https://app.codecov.io/gh/malcolmbarrett/metaconfoundr?branch=master)
<!-- badges: end -->
...
Please note that the metaconfoundr project is released with a [Contributor Code of Conduct](https://raw.githubusercontent.com/malcolmbarrett/metaconfoundr/master/.github/CODE_OF_CONDUCT.md). By contributing to this project, you agree to abide by its terms.
